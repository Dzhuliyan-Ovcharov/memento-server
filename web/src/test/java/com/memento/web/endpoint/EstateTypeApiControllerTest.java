...
import com.memento.web.constant.JsonPathConstant;
...
public class EstateTypeApiControllerTest extends BaseApiControllerTest {
    ...
    public void verifyGetAllEstateTypesAndExpect200() throws Exception {
        final String jsonResponse = loadJsonResource(JsonPathConstant.ESTATE_TYPE_COLLECTION_JSON_PATH, EstateType[].class);
    ...
    public void verifySaveAndExpect200() throws Exception {
        final String jsonRequest = loadJsonResource(JsonPathConstant.ESTATE_TYPE_JSON_PATH, EstateType.class);
    ...
    public void verifyUpdateAndExpect200() throws Exception {
        ...
        when(estateTypeService.update(anyLong(), any(EstateType.class))).thenReturn(estateType);
    ...
    public void verifyUpdateWhenEstateTypeIdDoesNotMatchWithPassedIdAndExpect400() throws Exception {
        ...
        when(estateTypeService.update(anyLong(), any(EstateType.class))).thenThrow(BadRequestException.class);
    ...
    public void verifyUpdateWhenEstateTypeIsNotFoundAndExpect404() throws Exception {
        ...
        when(estateTypeService.update(anyLong(), any(EstateType.class))).thenThrow(ResourceNotFoundException.class);
